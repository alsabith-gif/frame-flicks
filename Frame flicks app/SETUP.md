...
able to show the delivery date, per-step dates, or the correct set of steps
for that project's ticked services.
...
delivery date, a date under each completed step, any note you leave them,
and buttons to message you on WhatsApp/email. They **cannot** see your
