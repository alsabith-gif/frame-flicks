...
import { trackLinkFor, copyTrackLink } from '../tracklink.js';
...
function rowActionsHtml(e, size) {
  ...
  return `
    <div class="row-actions">
      <button class="btn btn-icon${sz}" data-action="link" data-id="${e.id}" title="Copy client progress link">🔗</button>
...
function openIncomeModal(id) {
  ...
  body.innerHTML = `
    <div class="form-grid">
      ...
      <div class="form-actions">
        ...
        ${existing ? '<button class="btn btn-ghost" id="copyLinkBtn">🔗 Copy Client Link</button>' : ''}
  ...
  if (existing) {
    body.querySelector('#copyLinkBtn').addEventListener('click', () => copyTrackLink(existing));
